...
public class AbMathUtil{
   ...
   */
     ...
     * @return
     */
    public static float findMaxValue(List<String> viewData) {
		List<Float> ints = new ArrayList<Float>();
		for (String s : viewData) {
			ints.add(Float.parseFloat(s));
		}
		float max = Collections.max(ints);
		return max;
	}
	 ...
	 * @return
	 */
	public static float getMinValue(List<String> datas) {
		String dataStr = Collections.min(datas);
		DecimalFormat df = new DecimalFormat("#.00");
		String value = df.format(Float.parseFloat(dataStr));
	 ...
	 * @return
	 */
	public static String yiweixiaoshu1(String value) {
